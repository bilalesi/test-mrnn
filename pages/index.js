        ...
        <div className='flex flex-col items-center justify-center min-h-screen h-full'>
            <div className='flex flex-col items-center justify-center'>
                ...
                <form action="/users" method="POST" onSubmit={handleAddNewUser}>
                    <input placeholder='Name' className='p-2 border border-red-200 rounded-lg h-12 mr-2' type="text" name="name"  />
                    <input placeholder='Phone' className='p-2 border border-red-200 rounded-lg h-12 mr-2'  type="tel" name="phone"/>
